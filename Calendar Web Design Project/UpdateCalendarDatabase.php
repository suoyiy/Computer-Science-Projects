...
<?php
    ...
    $prevDayTime = $currentTime - (60*60*24);
    $nextDayTime = $currentTime + (60*60*24);
    ...
    echo "<div> <form id='nextday' method='get' action='AdvancedCalendar.php'> <p> <input type='hidden' name='time_stamp' value='{$nextDayTime}' /> <input type='submit' name = 'pageSelection' value='Next Day'/> </p> </form>";
    ...
    echo "<div> <form id='prevday' method='get' action='AdvancedCalendar.php'> <p> <input type='hidden' name='time_stamp' value='{$prevDayTime}' /> <input type='submit' name = 'pageSelection' value='Prev Day'/> </p> </form>";
